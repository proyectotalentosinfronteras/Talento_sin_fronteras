document.addEventListener('DOMContentLoaded', () => {
    ...
    function getAIResponse(userInput) {
        ...
        // Respuestas de seguimiento al Bloque 1 (Menú Principal por números)
        if (ultimoContexto === "pregunta_saludo") {
            if (input === '1' || input.includes('opcion 1') || input.includes('opción 1') || input.includes('papeles') || input.includes('regularizar') || input.includes('masiva') || input.includes('primero')) {
                ultimoContexto = ""; 
                return getAIResponse("requisitos"); 
            } else if (input === '2' || input.includes('opcion 2') || input.includes('opción 2') || input.includes('titulo') || input.includes('homologar') || input.includes('estudios') || input.includes('segundo')) {
                ultimoContexto = "";
                return getAIResponse("homologar");
            } else if (input === '3' || input.includes('opcion 3') || input.includes('opción 3') || input.includes('derechos') || input.includes('trabajo') || input.includes('laboral') || input.includes('tercero')) {
                ultimoContexto = "";
        ...
        if (input.includes('hola') || input.includes('buenas') || input === 'menu' || input === 'menú' || input === 'inicio') {
